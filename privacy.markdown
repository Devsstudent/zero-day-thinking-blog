...
We may use standard analytics tools (like Google Analytics or GitHub Pages internal metrics) that collect anonymous, aggregate data. This log data may include:
- Your IP address
